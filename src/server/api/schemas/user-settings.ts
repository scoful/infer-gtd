...
export const getUserSettingsSchema = z
  .object({
    category: z
      .enum(["autoJournalGeneration", "notifications", "ui"])
      .optional(),
  })
  .optional()
  .default({});
...
export type AutoJournalSettings = NonNullable<
  UserSettings["autoJournalGeneration"]
>;
