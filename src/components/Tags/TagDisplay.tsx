    ...
    >
      ...
      {showRemove && onRemove && (
        <button
          ...
          className={`rounded-full p-0.5 transition-colors hover:bg-black hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 ${sizeClasses.removeButton} `}
          title="移除标签"
          tabIndex={0}
          onKeyDown={(e) => {
